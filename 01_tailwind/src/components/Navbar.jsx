...
const Navbar = () => {
  return (
    <nav className='bg-black text-white p-4 flex justify-content items-center gap-96 rounded-2xl'>
         <h1 className='text-5xl font-bold'><span className='text-amber-700'>A</span>darsh</h1>
